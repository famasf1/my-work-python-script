            ...
            for a in range(1, num_attach+1):
                ...
                if (attachment.FileName).endswith('xlsx'):
                    ...
                    try:
                        ...
                        ws = wb[wb_name[0]]
                        shipment_last_4digit = ws['A2'].value[-4:]
                        print(shipment_last_4digit)
                        shipment_time = ws['B2'].value
                        str(shipment_time).replace(":","-")
                        new_name_path = os.path.join(EXCEL_FOLDER_PATH, f"{shipment_time}_{shipment_last_4digit}.xlsx".replace(":","-"))
